  ...
  function SalaryForm() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "onCalculate", function () {
      ...
      if (new Date(date) < new Date()) {
        ...
        console.log("you usd ", getD("USD", usd, date, value));
        console.log("you cer ", getD("CER", cer, date, value));
        console.log("you uva ", getD("UVA", uva, date, value));
        console.log("you uvi ", getD("UVI", uvi, date, value));
        var data = [];
        data.push(getD("USD", usd, date, value));
        data.push(getD("CER", cer, date, value));
        data.push(getD("UVA", uva, date, value));
        data.push(getD("UVI", uvi, date, value));
...
//# sourceMappingURL=index.js.7bffd1d9e3e9a406d1fc.hot-update.js.map