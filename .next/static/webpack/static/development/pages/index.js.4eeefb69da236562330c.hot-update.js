...
function calculatePrice(index, usd, date, value) {
  ...
  if (past_obj && past_product_price && current_product_price) {
    ...
    var _past_available_product = past_available_dollar / past_product_price[index];

    var current_necesary_dollar = _past_available_product * current_product_price[index];
    ...
    var object = {
      index: index,
      could: _past_available_product.toFixed(2),
...
//# sourceMappingURL=index.js.4eeefb69da236562330c.hot-update.js.map