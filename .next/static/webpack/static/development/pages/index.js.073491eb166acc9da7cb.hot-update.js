...
function calculatePrice(usd, date, value) {
  ...
  if (past_obj) {
    ...
    var past_product_price = _tprice_json__WEBPACK_IMPORTED_MODULE_16__[new Date(date).getFullYear()][product];
    ...
    var current_product_price = _tprice_json__WEBPACK_IMPORTED_MODULE_16__[new Date().getFullYear()][product];
...
//# sourceMappingURL=index.js.073491eb166acc9da7cb.hot-update.js.map