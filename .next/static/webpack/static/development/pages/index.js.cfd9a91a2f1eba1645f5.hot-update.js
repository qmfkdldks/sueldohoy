...
function calculatePrice(usd, date, value) {
  ...
  if (past_obj) {
    ...
    var past_product_price = _tprice_json__WEBPACK_IMPORTED_MODULE_16__[new Date().getFullYear()][product];
    ...
    var current_product_price = _tprice_json__WEBPACK_IMPORTED_MODULE_16__[date.getYear()][product];
  ...
  function SalaryForm() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "onCalculate", function () {
      ...
      if (new Date(date) < new Date()) {
        ...
        data.push(calculatePrice(usd, new Date(date), value));
...
//# sourceMappingURL=index.js.cfd9a91a2f1eba1645f5.hot-update.js.map